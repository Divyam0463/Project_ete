    ...
    return (
        <div className="footer">
            ...
            <div className="footer_hrt">
                <h3>Made with <span role="img" aria-label="necro">❤️</span> by <a href='https://github.com/Aniket021978' target="_blank" rel="noopener noreferrer">Harman Veer Singh</a></h3>
            </div>
